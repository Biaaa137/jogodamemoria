...
function createBoard(){
    for (let i = 0; i < cardArray.length; i++){
        ...
        card.setAttribute('src', './img/quadrado1.png')
...
function checkForMatch() {
    ...
    if(optionOneId == optionTwoId) {
        cards[optionOneId].setAttribute('src', './img/quadrado1.png')
        cards[optionTwoId].setAttribute('src', './img/quadrado1.png')
        ...
        cards[optionOneId].setAttribute('src', './img/cabou.png')
        cards[optionTwoId].setAttribute('src', './img/cabou.png')
